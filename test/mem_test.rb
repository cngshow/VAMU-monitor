...
while (true) do
 # sleep 1
  #puts `pwd`
  #puts `c:\\Java\\jdk1.6.0_30\\bin\\java -jar ../lib/jars/jruby-complete-1.7.11.jar -e "puts  Time.now.to_s"` #OK
  puts `c:\\Java\\jdk1.6.0_30\\bin\\java -jar ../lib/jars/jruby-complete-1.7.11.jar time.rb` #OK
