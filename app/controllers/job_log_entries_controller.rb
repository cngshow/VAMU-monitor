...
class JobLogEntriesController < ApplicationController
  ...
  def list
    ...
    @job_status_filter = [["---No Filter---", :NO_FILTER], ["Status Change Only", :STATUS_CHANGE_ONLY], ["Escalation Change Only", :ESCALATION_CHANGE_ONLY], ["Running Jobs Only", :RUNNING_JOBS_ONLY], ["E-Mailed Jobs Only", :EMAILED_JOBS_ONLY], ["Alerts Only", :ALERTS_ONLY], ["Non-Alerts Only", :NON_ALERTS_ONLY], ["Last Job Run", :LAST_JOB_RUN]]
    ...
    #strange, but it seems the mongo driver pads nil in the array beyond the limit.
    @job_log_entries.reject! do |jle| jle.nil? end
