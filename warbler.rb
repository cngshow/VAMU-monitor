...
Warbler::Config.new do |config|
  ...
  #"lib/jars/commons-exec-1.1.jar","lib/jars/jcl-over-slf4j-1.6.4.jar", "lib/jars/jruby-complete-1.7.11.jar", "lib/jars/metrics-data-service.jar", "lib/jars/ojdbc6.jar", "lib/jars/quartz-all-2.1.0.jar", "lib/jars/shamu_quartz.jar", "lib/jars/slf4j-api-1.6.4.jar", "lib/jars/slf4j-jdk14-1.6.4.jar", "lib/jars/ucp.jar",
